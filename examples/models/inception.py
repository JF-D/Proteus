...
class InceptionA(nn.Module):
    def __init__(self, in_channels: int, pool_features: int, conv_block=None):
        super().__init__()
        ...
        self.avg_pool2d = nn.AvgPool2d(3, stride=1, padding=1)
...
class InceptionC(nn.Module):
    def __init__(self, in_channels: int, channels_7x7: int, conv_block=None):
        super().__init__()
        if conv_block is None:
            conv_block = BasicConv2d
...
class InceptionE(nn.Module):
    ...
    def _forward(self, x):
        ...
        branch3x3 = torch.concat(branch3x3, dim=1)
        ...
        branch3x3dbl = torch.concat(branch3x3dbl, dim=1)
...
class InceptionAux(nn.Module):
    def __init__(self, in_channels: int, num_classes: int, conv_block=None):
        ...
        self.avg_pool2d = nn.AvgPool2d(5, stride=3)
...
def inception_v3(pretrained: bool = False, progress: bool = True, **kwargs):
