...
# copy from megatron: https://github.dev/NVIDIA/Megatron-LM/blob/main/megatron/mpu/layers.py
...
def split_tensor_along_dim(tensor,
                           num_partitions,
                           dim,
                           contiguous_split_chunks=False):
    """Split a tensor along its dimension.
    Arguments:
        tensor: input tensor.
        num_partitions: number of partitions to split the tensor
        contiguous_split_chunks: If True, make each chunk contiguous
